...
if (this.cai[chatId].character !== 'qwen-plus') return
...
let res = await fetch(`https://api.nekorinn.my.id/ai/qwen-plus?text=${text}&sessionid=${sessionid}`)
...
await this.sendPresenceUpdate('paused', chatId)
console.error(e)
await this.reply(chatId, '⚠️ *Qwen lagi mikir keras...* 🧠\n✨ *Coba tanya nanti lagi ya, atau panggil Izumi kalau butuh bantuan~*')
}
}