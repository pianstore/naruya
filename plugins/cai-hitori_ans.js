...
if (this.cai[chatId].character !== 'hitori-gotoh') return
...
let res = await fetch(`https://api.nekorinn.my.id/character-ai/hitori-gotoh?text=${text}&sessionid=${sessionid}`)
...
await this.sendPresenceUpdate('paused', chatId)
console.error(e)
await this.reply(chatId, '❌ *Hitori sedang panik...* 🥺\n🍓 *Tolong panggil Izumi buat bantuin ya...*')
}
}