...
if (this.cai[chatId].character !== 'hoshino-takanashi') return
...
let res = await fetch(`https://api.nekorinn.my.id/character-ai/hoshino-takanashi?text=${text}&sessionid=${sessionid}`)
...
await this.sendPresenceUpdate('paused', chatId)
console.error(e)
await this.reply(chatId, '❌ *Hoshino lagi tidur... Zzz.*\n🍓 *Coba panggil Izumi, mungkin aku butuh diperbaiki~ uhuk*')
}
}