...
if (this.cai[chatId].character !== 'gemini') return
...
let res = await fetch(`https://api.nekorinn.my.id/ai/gemini?text=${text}&sessionid=${sessionid}`)
...
await this.sendPresenceUpdate('paused', chatId)
console.error(e)
await this.reply(chatId, '🍰 *Gemini lagi error...*\n🌸 *Coba tanya lagi sebentar ya~*')
}
}